  ...
  context 'when change index' do
    let(:actual_dsl) {
      erbh(<<-EOS)
        ...
        <%= add_index "departments", ["dept_name"], name: "idx_dept_name", unique: true} + cond(5.0, using: :btree)) %>
        ...
        <%= add_index "dept_emp", ["dept_no"], name: "idx_dept_emp_dept_no"} + cond(5.0, using: :btree)) %>
        <%= add_index "dept_emp", ["emp_no"], name: "idx_dept_emp_emp_no"} + cond(5.0, using: :btree)) %>
        ...
        <%= add_index "dept_manager", ["dept_no"], name: "idx_dept_manager_dept_no"} + cond(5.0, using: :btree)) %>
        <%= add_index "dept_manager", ["emp_no"], name: "idx_dept_manager_emp_no"} + cond(5.0, using: :btree)) %>
        ...
        <%= add_index "salaries", ["emp_no"], name: "idx_salaries_emp_no"} + cond(5.0, using: :btree)) %>
    ...
    let(:expected_dsl) {
      erbh(<<-EOS)
        ...
        <%= add_index "dept_emp", ["dept_no"], name: "idx_dept_emp_dept_no"} + cond(5.0, using: :btree)) %>
        <%= add_index "dept_emp", ["from_date"], name: "idx_dept_emp_emp_no"} + cond(5.0, using: :btree)) %>
        ...
        <%= add_index "dept_manager", ["dept_no"], name: "idx_dept_manager_dept_no"} + cond(5.0, using: :btree)) %>
        <%= add_index "dept_manager", ["from_date"], name: "idx_dept_manager_emp_no"} + cond(5.0, using: :btree)) %>
        ...
        <%= add_index "salaries", ["from_date"], name: "idx_salaries_emp_no"} + cond(5.0, using: :btree)) %>
