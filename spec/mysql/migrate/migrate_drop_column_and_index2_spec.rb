    ...
    let(:expected_dsl) do
      erbh(<<-ERB)
        ...
        create_table "dept_emp", id: false, force: :cascade do |t|
          ...
          t.string  "dept_no", null: false
          t.index ["dept_no"], name: "dept_no", <%= i cond(5.0, using: :btree) %>
          t.index ["emp_no2"], name: "emp_no", <%= i cond(5.0, using: :btree) %>
        end
        ...
        create_table "employee_clubs", force: :cascade do |t|
          t.integer "emp_no", null: false
          t.integer "club_id2", null: false
          t.index ["emp_no", "club_id2"], name: "idx_emp_no_club_id2", <%= i cond(5.0, using: :btree) %>
          t.index ["emp_no"], name: "idx_emp_no_club_id", <%= i cond(5.0, using: :btree) %>
        end
        ...
        create_table "salaries", id: false, force: :cascade do |t|
          ...
          t.date    "from_date", null: false
          t.date    "to_date", null: false
          t.index ["emp_no", "salary"], name: "emp_no", <%= i cond(5.0, using: :btree) %>
        end
