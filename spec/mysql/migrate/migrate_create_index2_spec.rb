  ...
  context 'when create index (use t.index)' do
    ...
    let(:expected_dsl) do
      erbh(<<-ERB)
        ...
        add_index "departments", ["dept_name"], name: "dept_name", unique: true
        ...
        add_index "dept_emp", ["dept_no"], name: "dept_no"
        add_index "dept_emp", ["emp_no"], name: "emp_no"
        ...
        add_index "dept_manager", ["dept_no"], name: "dept_no"
        add_index "dept_manager", ["emp_no"], name: "emp_no"
